...
import { createHumanResourceType } from '../../../../../../../../services/human-resource-type';
import { HumanResourceTypeDTO } from '../../../../../../../../types';
import { CreateHumanResourceTypeScreenProps } from './create.types';
import validationSchema from './create.validation';

const CreateHumanResourceTypeScreen: FC<CreateHumanResourceTypeScreenProps> = ({
  onClose,
}) => {
  ...
  const onSubmit = handleSubmit(data => {
    ...
    createHumanResourceType(newHumanResourceType)
      .then(() => {
        setSnackMessage({
          isError: false,
...
export default CreateHumanResourceTypeScreen;
