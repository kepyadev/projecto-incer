...
interface IAddExistentProducerTechnicianProps {
  modalHandleClose: () => void;
}
const AddExistentProducerTechnician: FC<IAddExistentProducerTechnicianProps> = ({
  modalHandleClose,
}) => {
...
export default AddExistentProducerTechnician;
