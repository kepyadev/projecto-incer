...
const LocationForm: FC<FormStepProps> = ({ onNext = () => {}, fazenda }) => {
  ...
  const [errorLocalization, setErrorLocalization] = useState<Boolean>(false);
  ...
  useEffect(() => {
    ...
    if (fazenda) {
      setProvince(fazenda[Fazenda.County][County.Province]![Province.Id]);
      setCounty(fazenda[Fazenda.County][County.Id]);
    }
